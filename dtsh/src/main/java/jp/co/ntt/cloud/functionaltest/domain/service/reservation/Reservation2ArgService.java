...
public class Reservation2ArgService {
    ...
    public void register(@ShardAccountParam String customerNo, Reservation reservation) {
    ...
    @Transactional
    @ShardWithAccount("customerNo")
    public Reservation findOne(@ShardAccountParam String customerNo, String reservationNo) {
    ...
    @Transactional
    @ShardWithAccount("customerNo")
    public void update(@ShardAccountParam String customerNo, Reservation reservation) {
    ...
    @Transactional
    @ShardWithAccount("customerNo")
    public void delete(@ShardAccountParam String customerNo, String reservationNo) {
