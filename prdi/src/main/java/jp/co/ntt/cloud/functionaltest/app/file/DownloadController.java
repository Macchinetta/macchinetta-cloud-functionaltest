...
public class DownloadController {
    ...
    /**
     * 一覧で選択されたファイルの署名付き URL を取得して返す。 クライアントは取得した書名付き URL を使って S3 から直接コンテンツをダウンロードするので EC2 上アプリにコンテンツダウンロード処理は必要ない
    ...
    public DirectUrlResponse getDownloadUrl(@RequestParam("key") String key) {
        ...
        URL presignedUrl = s3Helper.generatePresignedUrl(bucketName, key,
                expiration);
