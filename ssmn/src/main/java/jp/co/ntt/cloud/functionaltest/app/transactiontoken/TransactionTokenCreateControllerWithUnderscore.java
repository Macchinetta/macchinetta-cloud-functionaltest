...
public class TransactionTokenCreateControllerWithUnderscore {
    ...
    @PostMapping(value = WebPagePathConstants.TRANSACTIONTOKEN_CREATEWITHUNDERSCORE_1_1)
    @TransactionTokenCheck(type = TransactionTokenType.BEGIN)
    public String functionTest1_1_Create() {
        return WebPagePathConstants.TRANSACTIONTOKEN_CREATEOUTPUTUNDERSCORE;
    }

    @PostMapping(value = WebPagePathConstants.TRANSACTIONTOKEN_CREATEWITHUNDERSCORE_1_2)
