 ...
 */
@Component
@Profile("low-priority-queue")
public class LowPriorityQueueListener {
     ...
     */
    @JmsListener(destination = "${app.priority.queue.low.name}", concurrency = "${app.priority.queue.low.concurrency}")
